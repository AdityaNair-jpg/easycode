...
**Tool calls with `..` or `_stash` in their arguments (flagged, not excluded): 1 turns.**
...
Human review sample: `research/pilot/results/m2-dryrun-20260925/review_sample.csv`, 20 branches, seed 20260925 (up to 5 NO_TOOL and 5 other branches per model and condition). `human_label` is left empty.
